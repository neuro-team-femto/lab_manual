...
<mark> Update: </mark> As of Jan. 2025, Université de Franche-Comté, SUPMICROTECH and UTBM have joined team, as well as a number of other local academic institutions, in a new federated university called [Université Marie et Louis Pasteur](https://www.umlp.fr/), called after Louis Pasteur (who was born in [Dole](https://fr.wikipedia.org/wiki/Dole_(Jura)) and educated in Besançon) and his wife [Marie](https://fr.wikipedia.org/wiki/Marie_Pasteur) who recently gained recognition as a collaborator.  
...
It is important to understand that, while UMRs are the main building blocks of French academia, they are purely administrative units which have no financial or legal existence: UMRs cannot hire personnel, issue contracts, invoice or get paid by other entities, nor be held responsible legally. All of these operations rather involve the _tutelles_ of the UMRs. In practice, this means that nobody in the lab are employees of the FEMTO-ST Institute (which has no legal right to employ anyone), but can only be employed by one of its tutelles (CNRS, UMLP, SUPMICROTECH or UTBM). Similarly, our research budget is never hosted at FEMTO-ST: it resides in budget lines in either CNRS, UMLP, SUPMICROTECH or UTBM. Whenever we sign a contract, research or internship agreement, the signatory is not FEMTO-ST, but again one of CNRS, UMLP, SUPMICROTECH or UTBM. 
...
- depending on the tutelle in charge, some of the admin services handling your research procedures may be on-site (ex. administrative services for SUPMICROTECH are in the same building), others in other parts of the campus (e.g. UMLP), others in other parts of the country. For instance, CNRS procedures from the lab are all handled regionally, in the [_Délégation Régionale Centre-Est_](https://www.centre-est.cnrs.fr) in Nancy, but luckily involve a lot of remote/web services (see [list](../../becoming-a-lab-member/femto-st-web-services) here). 
...
Another important entity within CNRS is the [National Committee for Scientific Research](https://www.cnrs.fr/comitenational/) (CoNRS), which functions a bit like a democratic assembly, and is composed of elected and nominated researchers from CNRS UMRs across the country. CoNRS is divided into thematic sections (e.g. section 7 (renumbered 3 as of 2025) is computer science and control, section 26 is neuroscience, and so on). It is in charge of the recruitment and evaluaton of permanent CNRS researchers, and also advises the executive CNRS Institutes about questions linked to research strategy and science policy.  

!!! Note 
	CoNRS is in charge of the recruitment and evaluation of permanent CNRS researchers, who are recruited via a yearly call, or "concours". If you're a postdoc looking for a permanent research position in France, you may need to learn more about this system (ask your PI). There is notoriously little English-language information about the application process, but these blog posts [[1]](https://a3nm.net/work/applications/), [[2]](https://discrete-notes.github.io/CNRS-application), [[3]](https://games-automata-play.github.io/blog/applying_cnrs/) cover some of it. 

!!! Note 
	As a CNRS reseacher, PI JJA is himself continuously evaluated by CoNRS (namely, section 7). We have a yearly report called CRAC (compte-rendu d'activité chercheur), which is mostly admin (a web form), but also more detailed reports every 5 (2.5 year) and 10 semesters (5 year), called rapports à vague et à mi-vague. These are more involved (the order of 25 pages for mi-vague, and 50 pages for vague), and get formally reviewed, with a one-page commentary, which may then influence promotion decisions, etc. but mostly serve as useful feedback by peers. It's a useful system. If you're interested, [here](../../downloads/dossier_03_09_2025.pdf) is a copy of JJA's mi-vague report, covering the period from Oct. 2022 to July 2025, submitted for evaluation in Sept. 2025. 
...
### Université Marie et Louis Pasteur (UMLP) / ex- Université de Franche-Comté (UFC)
...
As of Jan. 2025, Université de Franche-Comté, SUPMICROTECH and UTBM have joined team, as well as a number of other local academic institutions, in a new federated university called [Université Marie et Louis Pasteur](https://www.umlp.fr/), which is now the official name of UFC. 

### What's the business with Université de Bourgogne Franche Comté ? 

From 2022-2025, UFC and neighboring Université de Bourgogne (UB) in Dijon made efforts towards creating a federated university called Université de Bourgogne Franche-Comté (UBFC). For political reasons, UB left the merger in 2024, and UBFC was therefore [discontinued](https://journal-du-palais.fr/au-sommaire/collectivites/2025-le-reve-d-une-grande-universite-regionale-est-mort). As of 2025, UFC as well as other local institutions, but not UB, have created a new institution called Université Marie et Louis Pasteur. On its side, UB has formed another 'coalition' called Université Bourgogne Europe (UBE). 

You may find old documents refering to Université de Bourgogne Franche-Comté, but as of 2025, these should typically be updated to UMLP (waiting for the next political drama). There's a little bit of understandable fatigue about name changes: if you enrolled as a PhD student in 2022, you were supposed to receive a PhD from UFC for half of your first year, then were told your PhD would be granted by UBFC, and by the time of your defense you became a UMLP PhD. Let's hope that the new venture UMLP endures on. 
